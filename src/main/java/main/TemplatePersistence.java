...
public class TemplatePersistence {
	...
	public static void main(String[] args) throws URISyntaxException {
		try {
			...
			//String resourceDir = "/html/views/templates-test/";
							...
							if (resource != null) {
								...
								if (newObject != null) {
									...
									rawJson = rawJson.replace("\"", "'");
									 ...
									 // Remove a primeira aspa simples (').
									rawJson = rawJson.replaceFirst("'", "");
							        
							        // Se houver, remove a ultima aspas simples (').
							        if (rawJson.lastIndexOf("'") == rawJson.length() - 1) {
